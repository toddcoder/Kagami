...
namespace Kagami.Library.Objects
{
   public readonly struct Date : IObject, IRangeItem, IFormattable
   {
      ...
      public static Tuple Months
      {
         get
         {
            var names = array("January", "February", "March", "April", "May", "June", "July", "August", "September", "October",
               "November", "December").Select(String.StringObject).ToArray();
      ...
      public static Tuple DaysOfTheWeek
      {
         get
         {
            var names = array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
               .Select(String.StringObject)
               .ToArray();
            return new Tuple(names);
         }
      }
