...
namespace Kagami.Library.Classes
{
	public abstract class BaseClass
	{
		...
		protected void iteratorMessages()
		{
         ...
         registerMessage("next()", (obj, msg) => iteratorFunc(obj, i => i.Next().Map(Some.Object).DefaultTo(() => None.NoneValue)));
			registerMessage("peek()", (obj, msg) => iteratorFunc(obj, i => i.Peek().Map(Some.Object).DefaultTo(() => None.NoneValue)));
			...
			registerMessage("step(_<Int>)", (obj, msg) => iteratorFunc<Int>(obj, msg, (i, c) => i.Step(c.Value)));
		}
