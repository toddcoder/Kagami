...
namespace Kagami.Library.Classes
{
   public class ResultClass : BaseClass
   {
      ...
      public override void RegisterMessages()
      {
         ...
         messages["isSuccess".get()] = (obj, _) => function<IObject>(obj, s => (Boolean)((IResult)s).IsSuccess);
         messages["isFailure".get()] = (obj, _) => function<IObject>(obj, s => (Boolean)((IResult)s).IsFailure);
