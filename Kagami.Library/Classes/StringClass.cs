...
namespace Kagami.Library.Classes
{
   public class StringClass : BaseClass, ICollectionClass
   {
      ...
      public override void RegisterMessages()
      {
         ...
         messages["[]"] = (obj, msg) => function<String, Int>(obj, msg, (s, i) => s.GetChar(i.Value));
         ...
         messages["center".Function("width", "pad")] = (obj, msg) =>
         ...
         messages["ljust".Function("width", "pad")] = (obj, msg) =>
         ...
         messages["rjust".Function("width", "pad")] = (obj, msg) =>
