...
public class StringClass : BaseClass, ICollectionClass
{
   ...
   public override void RegisterMessages()
   {
      ...
      messages["[](_<String>)"] = (obj, msg) => function<KString, KString>(obj, msg, (s, needle) => s[needle.Value]);
   }
   ...
   public override void RegisterClassMessages()
   {
      ...
      classMessages["lower".get()] = (_, _) => (KString)"abcdefghijklmnopqrstuvwxyz";
      classMessages["upper".get()] = (_, _) => (KString)"ABCDEFGHIJKLMNOPQRSTUVWXYZ";
      classMessages["alpha".get()] = (_, _) => (KString)"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
      classMessages["vlower".get()] = (_, _) => (KString)"aeiou";
      classMessages["vupper".get()] = (_, _) => (KString)"AEIOU";
      classMessages["clower".get()] = (_, _) => (KString)"bcdfghjklmnpqrstvwxyz";
      classMessages["cupper".get()] = (_, _) => (KString)"BCDFGHJKLMNPQRSTVWXYZ";
