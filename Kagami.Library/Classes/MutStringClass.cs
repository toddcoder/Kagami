...
public class MutStringClass : BaseClass, ICollectionClass
{
   ...
   public override void RegisterMessages()
   {
      ...
      registerMessage("print(_)", (obj, msg) => function<MutString, IObject>(obj, msg, (m, s) => m.Print(s.AsString)));
      registerMessage("println(_)", (obj, msg) => function<MutString, IObject>(obj, msg, (m, s) => m.PrintLine(s.AsString)));
