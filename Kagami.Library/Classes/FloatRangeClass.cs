...
public class FloatRangeClass : BaseClass
{
   ...
   public override void RegisterMessages()
   {
      ...
      messages["+(_<Float>)"] = (obj, msg) => function<FloatRange, Float>(obj, msg, (r, i) => r.Add(i.Value));
      messages["-(_<Float>)"] = (obj, msg) => function<FloatRange, Float>(obj, msg, (r, i) => r.Subtract(i.Value));
