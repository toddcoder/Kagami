...
namespace Kagami.Library.Parsers.Statements
{
	...
	{
		static IMatched<(Expression condition, Expression expression)> getReturn(ParseState state)
		{
			var returnFromLoopParser = new ReturnFromLoopParser();
			return returnFromLoopParser.Scan(state).Map(u => (returnFromLoopParser.Condition, returnFromLoopParser.Expression));
		}
