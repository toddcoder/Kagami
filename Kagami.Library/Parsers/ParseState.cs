...
namespace Kagami.Library.Parsers
{
   public class ParseState : IEnumerable<Statement>
   {
      ...
      protected Stack<List<Statement>> statementStack;
      ...
      protected IMaybe<int> exceptionIndex;
      protected Stack<bool> yieldingStack;
      protected Stack<IMaybe<TypeConstraint>> returnTypesStack;
      protected Hash<string, Expression> defExpressions;
      protected Hash<string, Function> macros;
      protected Stack<IMaybe<IPrefixCode>> prefixCodes;
      protected Stack<IMaybe<ImplicitState>> implicitStates;
      protected Stack<ImplicitExpressionState> implicitExpressionStates;
