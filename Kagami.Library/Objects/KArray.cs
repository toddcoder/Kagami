...
public class KArray : IObject, IObjectCompare, IComparable<KArray>, IEquatable<KArray>, IMutableCollection, ISliceable
{
   ...
   public KBoolean Between(IObject min, IObject max, bool inclusive) => new(between(this, min, max, inclusive));

   public KBoolean After(IObject min, IObject max, bool inclusive) => new(after(this, min, max, inclusive));
   ...
   KString ICollection.MakeString(string connector) => MakeString(connector);
   ...
   KBoolean IMutableCollection.IsEmpty => IsEmpty;
