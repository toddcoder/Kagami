...
namespace Kagami.Drawing
{
   public class SizeClass : BaseClass
   {
      ...
      public override void RegisterMessages()
      {
         ...
         messages["width".get()] = (obj, msg) => function<Size>(obj, s => s.Width);
         messages["height".get()] = (obj, msg) => function<Size>(obj, s => s.Height);
         ...
         messages["isEmpty".get()] = (obj, msg) => function<Size>(obj, s => s.IsEmpty);
      }
   }
}